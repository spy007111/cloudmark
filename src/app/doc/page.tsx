            ...
            <CardContent className="p-6 md:p-8 space-y-8">
              ...
              <motion.div variants={item} className="space-y-6">
                ...
                <ol className="list-decimal list-outside ml-5 space-y-4 text-muted-foreground">
                  <li>
                    <span className="text-foreground font-medium">{t("method1.steps.1")}</span> 
                    <kbd className="px-2 py-1 mx-1 text-xs font-semibold rounded bg-muted border border-border">{t("keyboard.showBookmarks")}</kbd> 
                    {t("method1.steps.1_end")}
                  </li>
                  <li>
                    <span className="text-foreground font-medium">{t("method1.steps.2")}:</span>
                  ...
                  <li>
                    <span className="text-foreground font-medium">{t("method1.steps.3")}</span>
                  </li>
                </ol>
              </motion.div>
              ...
              <motion.div variants={item} className="space-y-6">
                ...
                <ol className="list-decimal list-outside ml-5 space-y-4 text-muted-foreground">
                  <li>
                    <span className="text-foreground font-medium">{t("method2.steps.1")}</span> 
                    <kbd className="px-2 py-1 mx-1 text-xs font-semibold rounded bg-muted border border-border">{t("keyboard.showBookmarks")}</kbd> 
                    {t("method2.steps.1_end")}
                  </li>
                  <li>
                    <span className="text-foreground font-medium">{t("method2.steps.2")}</span>
                  </li>
                  <li>
                    <span className="text-foreground font-medium">{t("method2.steps.3", { mark })}</span>
                  </li>
                  <li>
                    <span className="text-foreground font-medium">{t("method2.steps.4")}</span>
                  </li>
                  <li>
                    <span className="text-foreground font-medium">{t("method2.steps.5")}</span>
                  </li>
                  <li>
                    <span className="text-foreground font-medium">{t("method2.steps.6")}</span>
                  </li>
                </ol>
              </motion.div>
              ...
              <motion.div variants={item} className="space-y-6">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <ol className="list-decimal list-outside ml-5 space-y-4">
                    <li>
                      <span className="text-foreground font-medium">{t("usage.steps.1", { mark })}</span>
                    </li>
                    <li>
                      <span className="text-foreground font-medium">{t("usage.steps.2")}</span>
                    </li>
                    <li>
                      <span className="text-foreground font-medium">{t("usage.steps.3")}:</span>
                      <ul className="list-disc list-outside ml-5 mt-2 space-y-2">
