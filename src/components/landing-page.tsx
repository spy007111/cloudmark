      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          ...
          <nav className="ml-auto flex gap-4 sm:gap-6 items-center">
            <Link href="/doc" className="text-sm font-medium text-muted-foreground hover:text-primary">
              Docs
            </Link>
            <Link href="https://github.com/wesleyel/cloudmark" className="text-sm font-medium text-muted-foreground hover:text-primary">
